...
- **Contribution**: lab-tests: WB smoke pass rate (4/4 = 1.000) — each lab-AGENTS PASS prevents one prod-outage class for the wiki-bench lab; contributes to Quality KR via reduced incidents.
