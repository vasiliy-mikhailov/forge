...
- **Measurement source**: lab-tests: WI (8 phase-section headers + lab-AGENTS-runner band)
- **Contribution**: lab-tests: WI smoke pass rate (4/4 = 1.000) — each lab-AGENTS PASS prevents one prod-outage class for the wiki-ingest lab; contributes to Quality KR via reduced incidents.
