...
- test_when_reference_fsm_plays_same_seed_twice_then_scores_match_exactly
- test_when_run_canonical_eval_completes_then_result_has_mean_median_std_max_tile_n_games_walltime
