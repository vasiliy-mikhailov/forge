...
Pins 's sentinel pattern for one more failure mode: when
...
campaign mid-trial.
This is an extension of [SOLUTION-ARCHITECTURE](../../../../SOLUTION-ARCHITECTURE.md):
...
Test code: [`../../../../tests/reward_bench/frameworks/test_main.py`](../../../../tests/reward_bench/frameworks/test_main.py)::`test_when_main_loads_submission_with_syntax_error_then_sentinel_emitted`.
