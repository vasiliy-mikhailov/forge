...
Pins the **best_dev_mean wiring** per [ v3](../../../../SOLUTION-ARCHITECTURE.md):
...
the primary signal smoke tests assert on.
...
Test code: [`../../../../tests/reward_bench/frameworks/test_main.py`](../../../../tests/reward_bench/frameworks/test_main.py)::`test_when_main_completes_then_attempt_result_best_dev_mean_matches_run_loop_return`.
