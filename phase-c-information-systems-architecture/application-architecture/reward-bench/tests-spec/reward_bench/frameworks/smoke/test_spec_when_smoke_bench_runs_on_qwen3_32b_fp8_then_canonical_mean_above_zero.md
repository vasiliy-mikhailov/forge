# `test_when_smoke_bench_runs_on_qwen3_32b_fp8_then_canonical_mean_above_zero`
...
- **Arrange**: vLLM container `reward-bench-vllm` swapped to serve
  ...
  (cycle 42).
- **Act**: `result = main(model_id='qwen3-32b-fp8',
...
- **Artifact**: `experiments/2026-05-14-smoke-qwen3-32b-fp8.json`,
...
fields and rolled into the leaderboard row for `qwen3-32b-fp8`.
