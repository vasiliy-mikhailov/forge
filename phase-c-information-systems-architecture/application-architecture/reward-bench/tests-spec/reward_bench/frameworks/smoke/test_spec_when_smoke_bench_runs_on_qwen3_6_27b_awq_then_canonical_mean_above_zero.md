# `test_when_smoke_bench_runs_on_qwen3_6_27b_awq_then_canonical_mean_above_zero`

Pins the **smoke screen** per [ADR 0009](
../../../../docs/adr/0009-multi-model-smoke-bench-convention.md)
for `ModelTarget(id='qwen3.6-27b-awq',
...
- **Artifact**: `experiments/2026-05-14-smoke-qwen3.6-27b-awq.json`,
...
fields and rolled into the leaderboard row for `qwen3.6-27b-awq`.
