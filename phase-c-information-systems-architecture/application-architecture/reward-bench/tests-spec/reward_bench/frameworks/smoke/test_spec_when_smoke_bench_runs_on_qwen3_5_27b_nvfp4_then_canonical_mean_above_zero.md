# `test_when_smoke_bench_runs_on_qwen3_5_27b_nvfp4_then_canonical_mean_above_zero`

Pins the **smoke screen** per [ADR 0009](
../../../../docs/adr/0009-multi-model-smoke-bench-convention.md)
for `ModelTarget(id='qwen3.5-27b-nvfp4',
hf_path='kaitchup/Qwen3.5-27B-NVFP4',
served_name='qwen3.5-27b-nvfp4',
max_model_len=131072,
tool_call_parser='qwen3_xml')`.

- **Arrange**: vLLM container `reward-bench-vllm` swapped to serve
  `qwen3.5-27b-nvfp4` via
  [`ensure_serving_model(target)`](../../../../src/tier1/inference.py)
  (cycle 42).
- **Act**: `result = main(model_id='qwen3.5-27b-nvfp4',
...
- **Artifact**: `experiments/2026-05-14-smoke-qwen3.5-27b-nvfp4.json`,
...
fields and rolled into the leaderboard row for `qwen3.5-27b-nvfp4`.
