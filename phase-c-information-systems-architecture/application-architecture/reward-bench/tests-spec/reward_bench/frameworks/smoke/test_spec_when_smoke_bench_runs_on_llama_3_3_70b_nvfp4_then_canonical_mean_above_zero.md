# `test_when_smoke_bench_runs_on_llama_3_3_70b_nvfp4_then_canonical_mean_above_zero`

Pins the **smoke screen** per [ADR 0009](
../../../../docs/adr/0009-multi-model-smoke-bench-convention.md)
for `ModelTarget(id='llama-3.3-70b-nvfp4',
...
- **Arrange**: vLLM container `reward-bench-vllm` swapped to serve
  `llama-3.3-70b-nvfp4` via
  [`ensure_serving_model(target)`](../../../../src/tier1/inference.py)
  (cycle 42).
- **Act**: `result = main(model_id='llama-3.3-70b-nvfp4',
...
- **Artifact**: `experiments/2026-05-14-smoke-llama-3.3-70b-nvfp4.json`,
...
fields and rolled into the leaderboard row for `llama-3.3-70b-nvfp4`.
