# `test_when_smoke_bench_runs_on_gemma_4_31b_fp8_then_canonical_mean_above_zero`

Pins the **smoke screen** per [ADR 0009](
../../../../docs/adr/0009-multi-model-smoke-bench-convention.md)
for `ModelTarget(id='gemma-4-31b-fp8',
hf_path='google/gemma-4-31B-it',
served_name='gemma-4-31b-fp8',
...
- **Arrange**: vLLM container `reward-bench-vllm` swapped to serve
  ...
  (cycle 42).
- **Act**: `result = main(model_id='gemma-4-31b-fp8',
...
- **Artifact**: `experiments/2026-05-14-smoke-gemma-4-31b-fp8.json`,
...
fields and rolled into the leaderboard row for `gemma-4-31b-fp8`.
