# `test_when_smoke_bench_runs_on_devstral_small_2_24b_then_canonical_mean_above_zero`

Pins the **smoke screen** per [ADR 0009](
../../../../docs/adr/0009-multi-model-smoke-bench-convention.md)
for `ModelTarget(id='devstral-small-2-24b',
...
- **Arrange**: vLLM container `reward-bench-vllm` swapped to serve
  `devstral-small-2-24b` via
  [`ensure_serving_model(target)`](../../../../src/tier1/inference.py)
  (cycle 42).
- **Act**: `result = main(model_id='devstral-small-2-24b',
...
- **Artifact**: `experiments/2026-05-14-smoke-devstral-small-2-24b.json`,
...
fields and rolled into the leaderboard row for `devstral-small-2-24b`.
