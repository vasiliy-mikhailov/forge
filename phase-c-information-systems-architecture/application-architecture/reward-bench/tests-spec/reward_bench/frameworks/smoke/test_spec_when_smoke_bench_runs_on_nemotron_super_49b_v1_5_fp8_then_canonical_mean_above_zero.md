# `test_when_smoke_bench_runs_on_nemotron_super_49b_v1_5_fp8_then_canonical_mean_above_zero`

Pins the **smoke screen** per [ADR 0009](
../../../../docs/adr/0009-multi-model-smoke-bench-convention.md)
for `ModelTarget(id='nemotron-super-49b-v1.5-fp8',
...
- **Arrange**: vLLM container `reward-bench-vllm` swapped to serve
  `nemotron-super-49b-v1.5-fp8` via
  [`ensure_serving_model(target)`](../../../../src/tier1/inference.py)
  (cycle 42).
- **Act**: `result = main(model_id='nemotron-super-49b-v1.5-fp8',
...
- **Artifact**: `experiments/2026-05-14-smoke-nemotron-super-49b-v1.5-fp8.json`,
...
fields and rolled into the leaderboard row for `nemotron-super-49b-v1.5-fp8`.
