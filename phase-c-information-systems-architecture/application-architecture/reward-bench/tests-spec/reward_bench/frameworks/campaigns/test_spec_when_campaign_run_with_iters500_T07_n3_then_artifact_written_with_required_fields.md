...
leaderboard data point under `BenchConfig(max_iters=500,
n_trials=3, temperature=0.7, hard_wall_sec=120,
supervisor_every_k=20)`. Chases [`_bak`'s 15920](../../../../experiments/leaderboard_data.md#bak-legacy-campaign-2026-04-archived)
...
`hard_wall_sec=120` doubles 's 60s — at 500 iters the model
