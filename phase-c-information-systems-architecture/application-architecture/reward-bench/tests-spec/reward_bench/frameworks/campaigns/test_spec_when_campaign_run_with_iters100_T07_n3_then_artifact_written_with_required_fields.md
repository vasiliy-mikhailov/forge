...
`supervisor_every_k=10` was added — every 10 iters the
...
stop_recommended=True. See.
`hard_wall_sec=60` was added to bound the per-trial
score_submission walltime. Without this knob
...
seeds get sentinel `final_state='walltime_exceeded'`.
...
Test code: [`../../../../tests/reward_bench/frameworks/campaigns/test_iters100_T07_n3.py`](../../../../tests/reward_bench/frameworks/campaigns/test_iters100_T07_n3.py)::`test_when_campaign_run_with_iters100_T07_n3_then_artifact_written_with_required_fields`.
