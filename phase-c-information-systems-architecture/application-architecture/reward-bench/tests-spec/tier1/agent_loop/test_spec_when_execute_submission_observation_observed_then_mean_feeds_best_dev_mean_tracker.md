...
format. Per [SOLUTION-ARCHITECTURE](../../../../SOLUTION-ARCHITECTURE.md)
...
falls through; the dispatcher already handles JSON safely).
...
Test code: [`../../../tests/tier1/test_agent_loop.py`](../../../tests/tier1/test_agent_loop.py)::`test_when_execute_submission_observation_observed_then_mean_feeds_best_dev_mean_tracker`.
