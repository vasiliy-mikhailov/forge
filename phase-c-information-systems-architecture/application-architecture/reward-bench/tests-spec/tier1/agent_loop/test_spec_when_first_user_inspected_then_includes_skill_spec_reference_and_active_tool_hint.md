...
Pins the **shape** of [`FIRST_USER`](../../../../src/tier1/agent_loop.py) (replaces cycle-39's `matches_bak_freeform_variant`
...
56 + 61 it MUST:
 ...
 read first;
 - mention `execute_submission` as the active tool ([SOLUTION-ARCHITECTURE](../../../../SOLUTION-ARCHITECTURE.md))
...
Test code: [`../../../tests/tier1/test_agent_loop.py`](../../../tests/tier1/test_agent_loop.py)::`test_when_first_user_inspected_then_includes_skill_spec_reference_and_active_tool_hint`.
