...
Pins the **Solver-instantiation probe** added.
## Why
a live run found qwen3.6-27b-awq submits a Solver whose
...
adds a one-shot probe in `_execute_submission` after
...
Test code: [`../../../tests/tier1/test_agent_loop.py`](../../../tests/tier1/test_agent_loop.py)::`test_when_execute_submission_solver_init_raises_then_protocol_violation_names_exception`.
