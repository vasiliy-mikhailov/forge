...
discovered the active loop without this guardrail lets the
...
uses:
- **Active path** ([SOLUTION-ARCHITECTURE](../../../../SOLUTION-ARCHITECTURE.md)):
...
Test code: [`../../../tests/tier1/test_agent_loop.py`](../../../tests/tier1/test_agent_loop.py)::`test_when_finish_called_below_finish_floor_then_rejected_and_loop_continues`.
