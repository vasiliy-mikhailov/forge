...
Pins the [SOLUTION-ARCHITECTURE](../../../../SOLUTION-ARCHITECTURE.md)
...
This is the application-side counterpart to (LlmSupervisor)
and (NullSupervisor default).
...
Test code: [`../../../tests/tier1/test_agent_loop.py`](../../../tests/tier1/test_agent_loop.py)::`test_when_supervisor_recommends_stop_then_run_loop_terminates_early`.
