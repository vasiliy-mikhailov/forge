...
worked.
parameterises `_call_model` and the chain feeding it:
...
Test code: [`../../../tests/tier1/test_agent_loop.py`](../../../tests/tier1/test_agent_loop.py)::`test_when_call_model_invoked_then_payload_model_field_matches_served_name`.
