...
After cycle 98 the three ports — `ModelClient`, `ToolRegistry`,
...
Cycle 99 makes `run_loop` accept the three ports as optional
...
- **Seam**: `run_loop(model_client=...)` directly (per cycle 99).
