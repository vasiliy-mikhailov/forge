...
The **prompt is software**: per [SOLUTION-ARCHITECTURE](../../../../SOLUTION-ARCHITECTURE.md)
...
MUST cause the model under test to either:
 ...
 - **`execute_submission`** (the active tool) with a
...
Test code: [`../../../tests/tier1/test_agent_loop.py`](../../../tests/tier1/test_agent_loop.py)::`test_when_first_reply_received_then_views_skill_spec_or_writes_protocol_valid_solver`.
