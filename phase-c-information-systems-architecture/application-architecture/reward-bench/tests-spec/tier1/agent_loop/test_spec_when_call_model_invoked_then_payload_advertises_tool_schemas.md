...
Pins the **OpenAI tools advertisement** added.
## Why
...
fixes this by passing `tools=TOOL_SCHEMAS` in every
...
Test code: [`../../../tests/tier1/test_agent_loop.py`](../../../tests/tier1/test_agent_loop.py)::`test_when_call_model_invoked_then_payload_advertises_tool_schemas`.
