...
introduced ([SOLUTION-ARCHITECTURE](../../../../SOLUTION-ARCHITECTURE.md)).
...
Test code: [`../../../tests/tier1/test_agent_loop.py`](../../../tests/tier1/test_agent_loop.py)::`test_when_execute_submission_called_with_valid_solver_body_then_returns_per_seed_observation`.
