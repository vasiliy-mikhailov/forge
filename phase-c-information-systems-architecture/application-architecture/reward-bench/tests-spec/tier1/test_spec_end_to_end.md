...
Mirrors src-spec/tier1/code_spec_end_to_end.md. Each entry pins one
observable layer of the end-to-end flow. All tests in this file are
implemented in tests/tier1/test_end_to_end.py and run against the
live qwen3.6-27b-awq container.
