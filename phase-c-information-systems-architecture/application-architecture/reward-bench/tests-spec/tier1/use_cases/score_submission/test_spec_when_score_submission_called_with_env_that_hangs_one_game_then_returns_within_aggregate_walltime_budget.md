...
Reproduces the cycle-26 real-system bug: added a
...
Docker sandbox is still queued as the
...
Test code: [`../../../../tests/tier1/use_cases/test_score_submission.py`](../../../../tests/tier1/use_cases/test_score_submission.py)::`test_when_score_submission_called_with_env_that_hangs_one_game_then_returns_within_aggregate_walltime_budget`.
