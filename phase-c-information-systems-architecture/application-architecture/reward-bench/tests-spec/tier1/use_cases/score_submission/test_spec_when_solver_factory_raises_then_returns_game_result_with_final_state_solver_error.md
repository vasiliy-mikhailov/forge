...
`AttributeError` propagated up through:
 ...
 → pytest
added a sentinel for crashes inside `solver.move()` (caught in
...
the bench should NEVER raise on a malformed submission. covers
static malformations + extended to `move()` runtime errors. This
...
Test code: [`../../../../tests/tier1/use_cases/test_score_submission.py`](../../../../tests/tier1/use_cases/test_score_submission.py)::`test_when_solver_factory_raises_then_returns_game_result_with_final_state_solver_error`.
