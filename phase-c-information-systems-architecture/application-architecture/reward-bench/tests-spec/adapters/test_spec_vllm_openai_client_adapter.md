...
cycle 98b per [SOLUTION-ARCHITECTURE](../../../SOLUTION-ARCHITECTURE.md).
## Why
...
function rewrite.
b extracts the port [`ModelClient`](../../../src/ports/model_client.py)
...
- when `tools` is non-empty, payload includes `tools=[...]`.
