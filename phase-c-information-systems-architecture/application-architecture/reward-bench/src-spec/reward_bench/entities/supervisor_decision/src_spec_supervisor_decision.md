...
is the frozen-entity return type of the supervisor (see [SOLUTION-ARCHITECTURE](../../../../SOLUTION-ARCHITECTURE.md)).
...
- `stop_recommended: bool` — distinct from `plateau` because conservative-bias the supervisor may classify the sweep
