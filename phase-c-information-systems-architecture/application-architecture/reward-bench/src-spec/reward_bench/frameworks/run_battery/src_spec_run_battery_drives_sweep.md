...
hosts the cycle 94 / cycle 102 sweep driver. Two public entry points:

## `run_battery(tier, task, filter_regex, registry_path, runner)`

Cycle 94. Iterates models.yml × the `make reward-bench` invocation.
...
Cycle 102 + 104. ADR 0003 canonical campaign (max_iters=500 × n_trials=10
× temperature=0.7) × ADR 0015 canonical hard_wall_sec=300 default.
