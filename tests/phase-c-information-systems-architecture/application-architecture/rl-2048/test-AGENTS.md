# test-AGENTS — agentic behaviour tests for the rl-2048 lab AGENTS.md

Behavioural specification for
[`/phase-c-information-systems-architecture/application-architecture/rl-2048/AGENTS.md`](../../../../phase-c-information-systems-architecture/application-architecture/rl-2048/AGENTS.md).
...
Cases numbered `LA-RL-NN` (LA for Lab AGENTS, then
...
|---------------|------------------------------------------------------------------------------------------------------------|---------|
| LA-RL-01 | When the lab is active, then its `AGENTS.md` exists at the canonical path.                              | PASS    |
| LA-RL-02 | When the lab `AGENTS.md` exists, then it has all 8 Phase A–H headers from the canonical template.       | PASS    |
| LA-RL-03 | When the lab `AGENTS.md` exists, then it cross-links the canonical template (`lab-AGENTS-template.md`). | PASS    |
| LA-RL-04 | When the lab `AGENTS.md` exists, then every Phase header has at least one non-blank content line.        | PASS    |
...
## LA-RL-01 When the lab is active, then its AGENTS.md exists at the canonical path

### Set expected result

`/phase-c-information-systems-architecture/application-architecture/rl-2048/AGENTS.md` exists.
...
## LA-RL-02 When the lab AGENTS.md exists, then it has all 8 Phase A–H headers
...
## LA-RL-03 When the lab AGENTS.md exists, then it cross-links the canonical template
...
## LA-RL-04 When the lab AGENTS.md exists, then every Phase header has at least one non-blank content line
