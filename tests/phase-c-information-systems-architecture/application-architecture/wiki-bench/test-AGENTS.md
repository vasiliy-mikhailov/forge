# test-AGENTS — agentic behaviour tests for the wiki-bench lab AGENTS.md

Behavioural specification for
[`/phase-c-information-systems-architecture/application-architecture/wiki-bench/AGENTS.md`](../../../../phase-c-information-systems-architecture/application-architecture/wiki-bench/AGENTS.md).
...
Cases numbered `LA-WB-NN` (LA for Lab AGENTS, then
...
|---------------|------------------------------------------------------------------------------------------------------------|---------|
| LA-WB-01 | When the lab is active, then its `AGENTS.md` exists at the canonical path.                              | PASS    |
| LA-WB-02 | When the lab `AGENTS.md` exists, then it has all 8 Phase A–H headers from the canonical template.       | PASS    |
| LA-WB-03 | When the lab `AGENTS.md` exists, then it cross-links the canonical template (`lab-AGENTS-template.md`). | PASS    |
| LA-WB-04 | When the lab `AGENTS.md` exists, then every Phase header has at least one non-blank content line.        | PASS    |
...
## LA-WB-01 When the lab is active, then its AGENTS.md exists at the canonical path

### Set expected result

`/phase-c-information-systems-architecture/application-architecture/wiki-bench/AGENTS.md` exists.
...
## LA-WB-02 When the lab AGENTS.md exists, then it has all 8 Phase A–H headers
...
## LA-WB-03 When the lab AGENTS.md exists, then it cross-links the canonical template
...
## LA-WB-04 When the lab AGENTS.md exists, then every Phase header has at least one non-blank content line
