# test-AGENTS — agentic behaviour tests for the wiki-compiler lab AGENTS.md

Behavioural specification for
[`/phase-c-information-systems-architecture/application-architecture/wiki-compiler/AGENTS.md`](../../../../phase-c-information-systems-architecture/application-architecture/wiki-compiler/AGENTS.md).
...
Cases numbered `LA-WC-NN` (LA for Lab AGENTS, then
...
|---------------|------------------------------------------------------------------------------------------------------------|---------|
| LA-WC-01 | When the lab is active, then its `AGENTS.md` exists at the canonical path.                              | PASS    |
| LA-WC-02 | When the lab `AGENTS.md` exists, then it has all 8 Phase A–H headers from the canonical template.       | PASS    |
| LA-WC-03 | When the lab `AGENTS.md` exists, then it cross-links the canonical template (`lab-AGENTS-template.md`). | PASS    |
| LA-WC-04 | When the lab `AGENTS.md` exists, then every Phase header has at least one non-blank content line.        | PASS    |
...
## LA-WC-01 When the lab is active, then its AGENTS.md exists at the canonical path

### Set expected result

`/phase-c-information-systems-architecture/application-architecture/wiki-compiler/AGENTS.md` exists.
...
## LA-WC-02 When the lab AGENTS.md exists, then it has all 8 Phase A–H headers
...
## LA-WC-03 When the lab AGENTS.md exists, then it cross-links the canonical template
...
## LA-WC-04 When the lab AGENTS.md exists, then every Phase header has at least one non-blank content line
