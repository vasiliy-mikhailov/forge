...
- [`phase-b-business-architecture/org-units/kurpatov-wiki-compiler/tests/smoke.md`](../labs/kurpatov-wiki-compiler/tests/smoke.md)
- [`phase-b-business-architecture/org-units/kurpatov-wiki-ingest/tests/smoke.md`](../labs/kurpatov-wiki-ingest/tests/smoke.md)
- [`phase-b-business-architecture/org-units/rl-2048/tests/smoke.md`](../labs/rl-2048/tests/smoke.md)
- [`phase-b-business-architecture/org-units/kurpatov-wiki-bench/tests/smoke.md`](../labs/kurpatov-wiki-bench/tests/smoke.md)
...
- **Bench co-running with compiler**. Bench has no caddy, so the
  ...
  (`make -C phase-b-business-architecture/org-units/kurpatov-wiki-bench smoke`) is a separate command,
