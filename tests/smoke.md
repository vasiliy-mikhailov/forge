...
- [`labs/kurpatov-wiki-compiler/tests/smoke.md`](../labs/kurpatov-wiki-compiler/tests/smoke.md)
- [`labs/kurpatov-wiki-ingest/tests/smoke.md`](../labs/kurpatov-wiki-ingest/tests/smoke.md)
- [`labs/rl-2048/tests/smoke.md`](../labs/rl-2048/tests/smoke.md)
- [`labs/kurpatov-wiki-bench/tests/smoke.md`](../labs/kurpatov-wiki-bench/tests/smoke.md)
...
- **Bench co-running with compiler**. Bench has no caddy, so the
  ...
  (`make -C labs/kurpatov-wiki-bench smoke`) is a separate command,
...
- [`docs/phase-g-implementation-governance/operations.md`](../docs/phase-g-implementation-governance/operations.md) — runbook for `make smoke`.
- ADR [`0007-labs-restructure-self-contained-caddy.md`](../docs/adr/0007-labs-restructure-self-contained-caddy.md)
