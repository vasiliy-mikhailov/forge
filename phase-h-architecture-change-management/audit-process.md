...
covers 9 units today: Architect, Auditor, Wiki PM, Developer,
DevOps, and each of the 4 lab AGENTS.md files (rl-2048, wiki-bench, wiki-compiler, wiki-ingest).
...
≥ 9 data rows and ≥ 5 columns; verify the unit names are the 9
canonical ones.
